...
class LightsensorTest(unittest.TestCase):
  ...
  def check_values(self,lf,ls,rs,rf):
    vs=self.values
    self.assertEqual(vs.left_forward,lf,"different value: lf")
    self.assertEqual(vs.left_side,ls,"different value: ls")
    self.assertEqual(vs.right_side,rs,"different value: rs")
    self.assertEqual(vs.right_forward,rf,"different value: rf")
    self.assertEqual(vs.sum_all,lf+ls+rf+rs,"different value: ")
    self.assertEqual(vs.sum_forward,lf+rf,"different value: ")
